...
<html lang="en">
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" id="building_no" aria-describedby="emailHelp" name="building_no" required>
  </div>

  <div class="mb-3">
    <label for="apartment_no" class="form-label">Apartment Number:</label>
    <input type="number" class="form-control" id="apartment_no" aria-describedby="emailHelp" name="apartment_no" required>
  </div>
  
  <div class="mb-3">
  <label for="attatchment" class="form-label">Attachment</label>
  <input class="form-control" type="file" id="attatchment" name="attatchment">
</div>
